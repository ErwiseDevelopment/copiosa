...
<div id="page" class="site">
    ...
    <header id="masthead" class="l-header site-header navbar-static-top <?php echo $post->post_title == 'Início' ? 'd-none' : 'mb-4'; ?> <?php echo wp_bootstrap_starter_bg_class(); ?>" role="banner">
